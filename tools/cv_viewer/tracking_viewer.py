...
def render_2D(left_display, img_scale, objects, is_tracking_on, class_names=None):
    ...
    for obj in objects.object_list:
        if render_object(obj, is_tracking_on):
            ...
            text = class_names[obj.raw_label] if class_names else "class " + str(obj.raw_label)
